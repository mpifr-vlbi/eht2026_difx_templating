...
class noemaPadPositions:
	...
	def __init__(self):
		...
		# Since 2024: pad names now 3-digit, after more antennas (ToDo: add also the new refpads)
		self.pads['W000'] = [   17.4321,  -54.6713, -17.6563 ]
		self.pads['N001'] = [   11.8205,  -55.0239, -11.9726 ]
		self.pads['N002'] = [    6.2035,  -55.3708,  -6.2833 ]
		self.pads['N003'] = [    0.5849,  -55.7232,  -0.5926 ]
		self.pads['N005'] = [  -10.6409,  -56.4214,  10.7789 ]
		self.pads['N007'] = [  -21.8689,  -57.1214,  22.1518 ]
		self.pads['N009'] = [  -33.1008,  -57.8196,  33.5285 ]
		self.pads['N011'] = [  -44.3355,  -58.5136,  44.9087 ]
		self.pads['N013'] = [  -55.5592,  -59.2193,  56.2766 ]
		self.pads['N015'] = [  -66.7863,  -59.9207,  67.6481 ]
		self.pads['N017'] = [  -78.0155,  -60.6202,  79.0233 ]
		self.pads['N020'] = [  -94.8616,  -61.6677,  96.0841 ]
		self.pads['N029'] = [ -145.4009,  -64.8169, 147.2738 ]
		self.pads['N040'] = [ -207.1579,  -68.6682, 209.8223 ]
		self.pads['N049'] = [ -240.8464,  -70.7678, 243.9441 ]
		self.pads['N054'] = [ -285.7644,  -73.5672, 289.4398 ]
		self.pads['W001'] = [   16.2163,  -62.4889, -16.4266 ]
		self.pads['W005'] = [   11.3515,  -93.7227, -11.5024 ]
		self.pads['W008'] = [    7.7069, -117.1487,  -7.8139 ]
		self.pads['W009'] = [    6.4919, -124.9643,  -6.5813 ]
		self.pads['W010'] = [    5.2780, -132.7724,  -5.3512 ]
		self.pads['W012'] = [    2.8484, -148.3853,  -2.8915 ]
		self.pads['W020'] = [   -6.8766, -210.8708,   6.9551 ]
		self.pads['W023'] = [  -10.5202, -234.3135,  10.6451 ]
		self.pads['W027'] = [  -15.3883, -265.5590,  15.5711 ]
		self.pads['E003'] = [   21.0757,  -31.2318, -21.3473 ]
		self.pads['E004'] = [   22.2913,  -23.4309, -22.5785 ]
		self.pads['E010'] = [   29.5828,   23.4370, -29.9600 ]
		self.pads['E012'] = [   32.0177,   39.0608, -32.4249 ]
		self.pads['E016'] = [   36.8755,   70.3000, -37.3469 ]
		self.pads['E018'] = [   39.3054,   85.9189, -39.8081 ]
		self.pads['E023'] = [   45.3817,  124.9799, -45.9624 ]
		self.pads['E024'] = [   46.5964,  132.7882, -47.1932 ]
		self.pads['E036'] = [   61.1899,  226.5125, -61.9599 ]
		self.pads['E048'] = [   75.7762,  320.2389, -76.7281 ]
